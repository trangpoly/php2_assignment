...
<body>
    <div class="signup">
        <h1 class="title">TẠO MỚI CÂU HỎI</h1>
        <form action="" method="POST" class="form-group" enctype="multipart/form-data">
            <label for="name" class="signup-label">Nội dung câu hỏi:</label>
            <input type="text" name="name" class="sign-input" placeholder="PHP tượng trưng cho cái gì:">
            <label for="inputState" class="signup-label">Quiz:</label>
            <select id="inputState" name= "quiz_id" class="form-control sign-input">
                <?php foreach($quiz_All as $quiz): ?>
                    <?php foreach(Subject::where('id',$quiz["subject_id"])->get() as $subject):?>
            ...
            <input type="text" name="img" class="sign-input" placeholder="image.png">
            <label for="answers" class="signup-label">Câu trả lời:</label><br>
            <label for="answers" class="signup-label">Đáp án 1:</label>
            <input type="text" name="answer1" class="sign-input" placeholder="Phương án A">
            <label for="answers" class="signup-label">Đáp án 2:</label>
            <input type="text" name="answer2" class="sign-input" placeholder="Phương án B">
            <label for="answers" class="signup-label">Đáp án 3:</label>
            <input type="text" name="answer3" class="sign-input" placeholder="Phương án C">
            <label for="answers" class="signup-label">Đáp án 4:</label>
            <input type="text" name="answer4" class="sign-input" placeholder="Phương án D">
            ...
            <button class="question_create" name="login">Tạo câu hỏi</button>
